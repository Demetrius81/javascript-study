...
console.log(`Сейчас ${switchDecade(day)} декада месяца`);
...
function separationByDischarge(n) {
  const i = 10;
  let arr = [];
  let index = 3;
...
let countArr = separationByDischarge(num);

console.log(`В числе ${num} количество сотен: ${countArr[2]}, десятков: ${countArr[1]}, единиц: ${countArr[0]}`);
